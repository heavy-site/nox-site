...
// Telegram is where an enquiry goes. Empty token or chat simply turns the
// notification off — the form keeps working, the enquiry still lands on disk,
// and the log says why nothing was sent.
